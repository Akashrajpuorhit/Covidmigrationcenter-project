<%-- 
    Document   : Negativecases
    Created on : 17 Aug, 2021, 11:21:32 PM
    Author     : admin
--%>
...
<html>
    ...
    <body>
         ...
         <br>
         <br>
     <form method="post" action="Negativecases.jsp">
        <div class="container">
...
<% 
                rs=s.executeQuery("select * from applycovid where result='negative'");
