   ...
   <script>
    ...
    <body>
        ...
        String t1 = request.getParameter("fstate");
         String t2 = request.getParameter("fcity");
         String t3 = request.getParameter("tstate");
...
out.println("<input type='text' readonly name='fcity'  class='txtb' value='"+ t2 +"'>");
  
 out.println("<input type='text' readonly name='tstate'  class='txtb' value='"+ t3 +"'>");
  rs= s.executeQuery("select * from CityTab  where stateName ='" + t3 +"'");
